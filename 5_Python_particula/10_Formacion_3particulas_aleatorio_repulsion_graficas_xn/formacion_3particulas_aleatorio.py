...
def formacion_3particulas(id):
    ...
    x1[0]=random.randrange(0, 10, 1) #Valor inicial x particula1
    y1[0]=random.randrange(0, 10, 1) #Valor inicial x particula1
    x2[0]=random.randrange(0, 10, 1) #Valor inicial x particula1
    y2[0]=random.randrange(0, 10, 1) #Valor inicial x particula1
    x3[0]=random.randrange(0, 10, 1) #Valor inicial x particula1randint(0, 9) #Valor inicial x particula1
    y3[0]=random.randrange(0, 10, 1) #Valor inicial x particula1
    ...
    pg.plot_xy_3particulas(e,x1,y1,x2,y2,x3,y3,id)
