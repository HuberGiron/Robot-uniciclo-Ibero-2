...
def plot_xy_3particulas_trayectoria(e,x1,y1,x2,y2,x3,y3,mcirc_x,mcirc_y,id):
     plt.figure(figsize=(9,9), dpi=300)
     plt.xlim(-10,10)
     plt.ylim(-10,10)
     plt.plot(x1, y1,ls='-', color = 'g', linewidth = '3')
     plt.plot(x2, y2,ls='-', color = 'g', linewidth = '3')
     plt.plot(x3, y3,ls='-', color = 'g', linewidth = '3')
     plt.plot(mcirc_x, mcirc_y,ls='-', color = 'm', linewidth = '3')
     
     plt.plot(x1[0], y1[0], 'o', ms = 10, mec = 'b', mfc = 'b')
     plt.plot(x1[len(x1)-1], y1[len(y1)-1], 'o', ms = 10, mec = 'r', mfc = 'r')

     plt.plot(x2[0], y2[0], 'o', ms = 10, mec = 'b', mfc = 'b')
     plt.plot(x2[len(x2)-1], y2[len(y2)-1], 'o', ms = 10, mec = 'r', mfc = 'r')

     plt.plot(x3[0], y3[0], 'o', ms = 10, mec = 'b', mfc = 'b')
     plt.plot(x3[len(x3)-1], y3[len(y3)-1], 'o', ms = 10, mec = 'r', mfc = 'r')

     plt.text(x1[0]+0.2, y1[0]-0.2, 
          '('+str(x1[0])+','+str(y1[0])+')', 
          style = 'italic',
          fontsize = 10,
          color = "blue")
     plt.text(x1[len(x1)-1]+0.2,y1[len(y1)-1], 
          '('+str("%.2f" % x1[len(x1)-1])+','+str("%.2f" % y1[len(y1)-1])+')', 
          style = 'italic',
          fontsize = 10,
          color = "red")
     
     plt.text(x2[0]+0.2, y2[0]-0.2, 
          '('+str(x2[0])+','+str(y2[0])+')', 
          style = 'italic',
          fontsize = 10,
          color = "blue")
     plt.text(x2[len(x2)-1]+0.2,y2[len(y2)-1], 
          '('+str("%.2f" % x2[len(x2)-1])+','+str("%.2f" % y2[len(y2)-1])+')', 
          style = 'italic',
          fontsize = 10,
          color = "red")
     
     plt.text(x3[0]+0.2, y3[0]-0.2, 
          '('+str(x3[0])+','+str(y3[0])+')', 
          style = 'italic',
          fontsize = 10,
          color = "blue")
     plt.text(x3[len(x3)-1]+0.2,y3[len(y3)-1], 
          '('+str("%.2f" % x3[len(x3)-1])+','+str("%.2f" % y3[len(y3)-1])+')', 
          style = 'italic',
          fontsize = 10,
          color = "red")
     ...
     plt.savefig('images/'+str(e.year)+'-'+str(e.month).zfill(2)+'-'+str(e.day).zfill(2)+'_'+str(e.hour).zfill(2)+str(e.minute).zfill(2)+str(e.second).zfill(2)+'_'+str(id)+'_position_xy.png')
     #plt.show()
     plt.close()

def plot_xy_3particulas(e,x1,y1,x2,y2,x3,y3,id):
     plt.figure(figsize=(9,9), dpi=300)
     plt.xlim(-10,10)
     plt.ylim(-10,10)
     plt.plot(x1, y1,ls='-', color = 'g', linewidth = '3')
