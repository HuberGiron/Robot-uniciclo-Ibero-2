...
while (True):
    ...
    print("V2="+str(V2)+"W1="+str(W2))  #Imprimir V y W
    print("wd2="+str(wd2)+"wi1="+str(wi2)) #Imprimir wi y wd
    print("V3="+str(V3)+"W1="+str(W3))  #Imprimir V y W
    print("wd3="+str(wd3)+"wi1="+str(wi3)) #Imprimir wi y wd
    print("V4="+str(V4)+"W1="+str(W4))  #Imprimir V y W
    print("wd4="+str(wd4)+"wi1="+str(wi4)) #Imprimir wi y wd
