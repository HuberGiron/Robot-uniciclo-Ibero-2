...
robot7=Bt.connect2("98:D3:31:F6:AC:8F")
print("Robot 7 OK")

print("Conectando Robot 5.....")
robot5=Bt.connect2("00:21:06:08:18:AD")
print("Robot 5 OK")

print("Conectando Robot 0.....")
robot0=Bt.connect2("98:D3:21:F7:B5:70")
print("Robot 0 OK")
...
robot_bt7=robot6 #Seleccion del robot a utilizar en el programa
robot_bt8=robot7 #Seleccion del robot a utilizar en el programa
...
#INICIALIZACION DE VALORES ROBOT FISICO 7
V7=0 #Velocidad Vx inicial
W7=0 #Velocidad angular robot inicial
wd7=0 #Velocidad angular motor derecho
wi7=0 #Velocidad angular motor izquierdo

#INICIALIZACION DE VALORES ROBOT FISICO 8
V8=0 #Velocidad Vx inicial
W8=0 #Velocidad angular robot inicial
wd8=0 #Velocidad angular motor derecho
wi8=0 #Velocidad angular motor izquierdo
...
while (True):
    ...
    #Calculo velocidad Angular de llantas robot 7
    wd7= (V7/r)+((L*W7)/(2*r)) #Calulo de wd robot unicilo
    wi7= (V7/r)-((L*W7)/(2*r)) #Calulo de wi robot unicilo

    if(wd7>wmax):    #Normalizamos el valor de wd a wmax 
        wd7=wmax
    elif(wd7<-wmax):
        wd7=-wmax

    if(wi7>wmax):    #Normalizamos el valor de wi a wmax 
        wi7=wmax
    elif(wi7<-wmax):
        wi7=-wmax

    #Calculo velocidad Angular de llantas robot 8
    wd8= (V8/r)+((L*W8)/(2*r)) #Calulo de wd robot unicilo
    wi8= (V8/r)-((L*W8)/(2*r)) #Calulo de wi robot unicilo

    if(wd8>wmax):    #Normalizamos el valor de wd a wmax 
        wd8=wmax
    elif(wd8<-wmax):
        wd8=-wmax

    if(wi8>wmax):    #Normalizamos el valor de wi a wmax 
        wi8=wmax
    elif(wi8<-wmax):
        wi8=-wmax
    ...
    print("V7="+str(V7)+"W7="+str(W7))  #Imprimir V y W
    print("wd7="+str(wd7)+"wi7="+str(wi7)) #Imprimir wi y wd
    print("V8="+str(V8)+"W8="+str(W8))  #Imprimir V y W
    print("wd8="+str(wd8)+"wi8="+str(wi8)) #Imprimir wi y wd
    ...
    Bt.move(robot_bt5,wd5,wi4)
    Bt.move(robot_bt6,wd6,wi4)
    Bt.move(robot_bt7,wd7,wi4)
    Bt.move(robot_bt8,wd8,wi4)
    time.sleep(0.1)
...
Bt.move(robot_bt7,0,0)   #Enviamos wd y wi en cero a robot bluetooth para detenerlo
Bt.move(robot_bt8,0,0)   #Enviamos wd y wi en cero a robot bluetooth para detenerlo
...
Bt.disconnect(robot_bt7) #Desconectamos Bluetooth
Bt.disconnect(robot_bt8) #Desconectamos Bluetooth