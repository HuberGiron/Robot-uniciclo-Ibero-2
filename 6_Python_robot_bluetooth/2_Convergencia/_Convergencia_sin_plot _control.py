...
while (True):
    ...
    if len(points)>0:
        ...
        x=robot[0][0]-(resolucionx/2) #Obtenemos valor X de QR robot 
        y=robot[0][1]-(resoluciony/2) #Obtenemos valor Y de QR robot 
        th=robot[0][2] #Obtenemos valor Th de robot 
        ...
        ex,ey,ux,uy=robotx.convergencia(x,y,xs,ys,k) #Calculo de errores y vector velocidad
